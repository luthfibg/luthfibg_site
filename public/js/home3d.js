...
Cube.prototype.rotateSides = function () {
    ...
    if (viewport.positionY > 90 && viewport.positionY < 270) {
        this.sides[0].getElementsByClassName("side-nav")[0].style[
            userPrefix.js + "Transform"
        ] = "rotate(" + (viewport.positionX + viewport.torqueX) + "deg)";
        this.sides[5].getElementsByClassName("side-nav")[0].style[
            userPrefix.js + "Transform"
...
Cube.prototype.upsideDown = function (obj) {
    ...
    while (i > 0 && --i) {
        this.sides[i].getElementsByClassName("side-nav")[0].style[
            userPrefix.js + "Transform"
        ] = "rotate(" + deg + ")";
    }
};
Cube.prototype.sideChange = function () {
    for (var i = 0; i < this.sides.length; ++i) {
        this.sides[i].getElementsByClassName("side-nav")[0].className =
            "side-nav";
    }

    this.sides[this.viewport.currentSide - 1].getElementsByClassName(
        "side-nav"
    )[0].className = "side-nav active";
};
